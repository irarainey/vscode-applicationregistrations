...
const password_credential_1 = require("../../src/services/password-credential");
// Create Jest mocks
jest.mock("vscode");
...
describe("Password Credential Service Tests", () => {
    ...
    const passwordCredentialService = new password_credential_1.PasswordCredentialService(graphApiRepository, treeDataProvider);
...
//# sourceMappingURL=password-credential.test.js.map
...
const key_credential_1 = require("../../src/services/key-credential");
// Create Jest mocks
jest.mock("vscode");
...
describe("Key Credential Service Tests", () => {
    ...
    const keyCredentialService = new key_credential_1.KeyCredentialService(graphApiRepository, treeDataProvider);
...
//# sourceMappingURL=key-credential.test.js.map
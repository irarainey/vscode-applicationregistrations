...
const oauth2_permission_scope_1 = require("../../src/services/oauth2-permission-scope");
// Create Jest mocks
jest.mock("vscode");
...
describe("OAuth2 Permission Scope Service Tests", () => {
    ...
    const oauth2PermissionScopeService = new oauth2_permission_scope_1.OAuth2PermissionScopeService(graphApiRepository, treeDataProvider);
...
//# sourceMappingURL=oauth2-permission-scope.test.js.map
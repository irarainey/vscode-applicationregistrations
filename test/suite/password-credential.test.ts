...
describe("Password Credential Service Tests", () => {
    ...
    const triggerCompleteSpy = jest.spyOn(Object.getPrototypeOf(passwordCredentialService), "triggerRefresh");
    const triggerErrorSpy = jest.spyOn(Object.getPrototypeOf(passwordCredentialService), "handleError");

...
describe("App Role Service Tests", () => {
    ...
    const triggerCompleteSpy = jest.spyOn(Object.getPrototypeOf(appRoleService), "triggerRefresh");
    const triggerErrorSpy = jest.spyOn(Object.getPrototypeOf(appRoleService), "handleError");

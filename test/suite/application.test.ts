...
describe("Application Service Tests", () => {
    ...
    const triggerCompleteSpy = jest.spyOn(Object.getPrototypeOf(applicationService), "triggerRefresh");
    const triggerErrorSpy = jest.spyOn(Object.getPrototypeOf(applicationService), "handleError");

...
describe("Owner Service Tests", () => {
    ...
    const triggerCompleteSpy = jest.spyOn(Object.getPrototypeOf(ownerService), "triggerRefresh");
    const triggerErrorSpy = jest.spyOn(Object.getPrototypeOf(ownerService), "handleError");
